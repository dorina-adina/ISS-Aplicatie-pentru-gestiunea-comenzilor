...
public class UI {
    ...
    public void adaugam() throws DuplicateException {
...
//        repo.adaugaFarmacist(farmacist1); repo.adaugaFarmacist(farmacist2);
        ...
        Comanda comanda1 = new Comanda(1, "ortopedie", "2024.03.12",  "in asteptare");
...
//        repo.adaugaComandaProdus(new ComandaProdus(2, 10009, 5));
    ...
    public void UIadaugareComanda() throws RepositoryException {
...
//        }
        ...
        comanda = new Comanda(id_comanda, sectie, data, status);
...
//    }
    ...
    public void meniu1() throws RepositoryException {
        adaugam();
        Scanner scanner = new Scanner(System.in);
        int choice; String str;
        do {
